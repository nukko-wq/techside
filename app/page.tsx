...
export default function Home() {
	return (
		<div className='px-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 py-4 max-w-7xl lg:max-w-full mx-auto overflow-hidden'>
			<div className='flex flex-col rounded-md h-[calc(100vh-theme(spacing.28))]'>
				...
				<div className='p-4 bg-slate-100 rounded-b-md overflow-y-auto flex flex-grow'>
			...
			<div className='flex flex-col rounded-md h-[calc(100vh-theme(spacing.28))]'>
				...
				<div className='p-4 bg-slate-100 rounded-b-md h- overflow-y-auto flex flex-grow'>
